...
状态：截至 2026-03-13，GA-01、GA-02、GA-03、GA-04、GA-05、GA-06 已完成，GA-07 待启动；本文件当前同时承担“Week 3-4 任务清单 + 完成记录”角色。
...
- 后端已建立 `knowledge / skills / agents` 正式模块骨架；其中 `knowledge` 已具备真实元数据模型、CRUD、上传入口、`global_docs` Chroma 写入与统一检索，但前端正式状态视图仍未接上。
- 当前还没有 `global_code` 真实导入、项目私有知识库、前端 `/knowledge` 正式接线，以及 Skill / Agent 正式资产能力。
