export const projectMessages = {
  nav: {
    ...
    resources: {
      label: "Resources",
      description: "Knowledge and skills in this project",
    },
    members: {
      label: "Members",
  ...
  overview: {
    summary: {
      ...
      hints: {
        ...
        coverageMix: "K {{knowledge}} · S {{skills}}",
      },
    },
    activity: {
      title: "Conversation activity trend",
      description:
        "Unique active conversations by UTC day over the last 7 days.",
      avg: "Daily avg",
      peak: "Peak",
    },
    knowledge: {
    ...
    coverage: {
      ...
      description: "Current composition across knowledge and skills.",
    ...
    insights: {
      ...
      items: {
        ...
        ai_cooling: {
          ...
          description: "No conversations were active in the last 7 days.",
        },
        knowledge_not_ready: {
        ...
        resource_stack_light: {
          ...
          description: "Only knowledge is connected; skills are still missing.",
        },
      },
    },
    states: {
  ...
  members: {
    ...
    removeDescription: "Remove {{name}} from the current project?",
    ...
    feedback: {
      ...
      updateRoleFailed: "Failed to update member role. Please try again later.",
  ...
  conversation: {
    ...
    composerPlusAria: "Open more input actions (coming soon)",
    skillPicker: {
      triggerAria: "Choose the Skill used for this conversation",
      title: "Choose a Skill for this turn",
      description: "Only team Skills already bound to the current project are shown.",
      empty: "No Skill is currently available in this project.",
      clear: "Clear selection",
      activeLabel: "Enabled: {{name}}",
    },
    ...
    sourceDrawer: {
      ...
      errorFallback: "Failed to load source",
      retry: "Retry",
      sourceLabel: "Source",
      distanceLabel: "Distance",
      chunkLabel: "Chunk",
      chunkValue: "Chunk {{index}}",
    ...
    actions: {
      ...
      deleteContent: 'Delete "{{title}}"? This action cannot be undone.',
      deleteConfirm: "Delete",
      cancel: "Cancel",
      deleteSuccess: '"{{title}}" deleted',
      deleteFailed: "Failed to delete conversation. Please try again later.",
  ...
  resources: {
    ...
    pageSubtitle: "Knowledge and skills for this project",
    pageDescription:
      "This page shows the knowledge bases and skills already enabled for the current project. Knowledge is split into bound global knowledge and project-private knowledge. The former continues through global governance, while the latter can be created and uploaded directly here.",
    ...
    nextStep:
      "The flow for adding {{title}} to this project will be connected here next.",
    ...
    skillAccess: {
      title: "Add skills",
      description:
        "Select one or more method assets from global Skills and add them to the current project.",
      placeholder: "Select Skills to add",
      confirm: "Add",
      cancel: "Cancel",
      empty: "No global Skills are currently available to add.",
      success: "{{count}} Skill(s) added to the project",
      selectRequired: "Select at least one Skill first",
    },
    ...
    summary: {
      ...
      layeredHint:
        "Global asset governance, project-side orchestration and consumption",
    ...
    access: {
      ...
      emptyFiltered: "No matching global knowledge. Try a different keyword.",
    ...
    draft: {
      ...
      documentTitlePlaceholder:
        "Title used when uploading the Markdown document",
      ...
      saved:
        "Project knowledge draft saved to the selected private knowledge base",
      createSuccess: "Project-private knowledge base created",
      createFailed:
        "Failed to create project knowledge base. Please try again later.",
      saveFailed: "Failed to save knowledge draft. Please try again later.",
    },
    mutations: {
      ...
      bindGlobalSuccess:
        "{{count}} global knowledge base(s) connected to the project",
      bindGlobalFailed:
