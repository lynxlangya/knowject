export const pagesMessages = {
  ...
  skills: {
    title: 'Skills',
    subtitle:
      'Turn skills into globally governed, reusable, and publishable method assets.',
    create: 'Create skill',
    import: 'Import skill',
    ...
    updatedAt: 'Updated {{value}}',
    action: {
      readonly: 'Built-in skill, view only',
      edit: 'Edit',
      publish: 'Publish',
      delete: 'Delete',
    },
    ...
    runtime: {
      ...
      contractOnly: 'Contract reserved',
      publishedContractOnly: 'Published · Contract reserved',
    },
    summary: {
      total: 'Skills total',
      totalValue: '{{count}}',
      ...
      publishedHintNone: 'There are no drafts pending cleanup right now.',
      publishedHintDrafts: '{{count}} skills are still in draft.',
      available: 'Runtime ready',
      availableValue: '{{count}}',
      availableHintAll: 'All current skills are connected to runtime.',
      availableHintPending: '{{count}} skills are still contract-only.',
      imported: 'Imported',
      importedValue: '{{count}}',
      importedHint: 'External skills from GitHub or URL.',
    },
    filters: {
      all: 'All',
      published: 'Published',
    ...
    editor: {
      ...
      cancel: 'Cancel',
      intro:
        'A skill uses native SKILL.md as the source of truth. New skills start as drafts and can be bound to agents or projects only after publishing.',
      invalid: 'The skill cannot be saved yet',
      valid: 'Frontmatter validation passed',
      placeholder: 'Enter the native SKILL.md content',
      validationPreview: 'Frontmatter validation issues were found before preview',
      waitingName: 'Waiting for name',
      waitingDescription: 'Waiting for description',
      waitingBody: 'The content after frontmatter will appear here.',
    },
    importFlow: {
      title: 'Import skill',
      submit: 'Import skill',
      cancel: 'Cancel',
      intro:
        'Import means ownership: the imported skill becomes your editable global asset and is not auto-synced back to the source in this phase.',
      github: 'GitHub',
      rawUrl: 'Raw Markdown URL',
      githubUrlPlaceholder: 'GitHub tree/blob/raw URL is preferred',
      githubHelp:
        'Supports `repository + path + ref`, and also pasting a GitHub URL directly. If the path points to a skill directory, the bundle structure is kept.',
      rawUrlHelp:
        'Only raw URLs that directly return Markdown text are supported. Web scraping and zip downloads are not supported.',
      preview: 'Preview import',
      imported: 'Imported from public web',
      draft: 'Draft',
    ...
    feedback: {
      ...
      frontmatterInvalid: 'Fix the SKILL.md frontmatter validation issues first',
      createdDraft: 'Skill draft created',
      saved: 'Skill saved',
      saveFailed: 'Saving the skill failed. Please try again later',
      previewFailed: 'Parsing the import preview failed. Check the source info',
      imported: 'Skill imported successfully and added to your global assets',
      importFailed: 'Importing the skill failed. Please try again later',
      published: '"{{name}}" has been published and can now be bound',
      publishFailed: 'Publishing the skill failed. Please try again later',
      deleteTitle: 'Delete "{{name}}"',
      deleteDescription:
        'After deletion, this skill is removed from the global asset catalog and will not sync back to the source automatically.',
      deleteConfirm: 'Delete',
      deleted: '"{{name}}" deleted',
    },
    markdown: {
      missingOpening: 'SKILL.md must start with --- frontmatter.',
      missingClosing: 'Add the closing frontmatter boundary ---.',
      missingName: 'Frontmatter must contain a non-empty name.',
      missingDescription:
        'Frontmatter must contain a non-empty description.',
      templateName: 'New Skill',
      templateDescription: 'Describe in one sentence what problem this skill solves.',
      templateBackground: 'Background',
      templateBackgroundGoal: 'What is the goal of this skill',
      templateBackgroundScene: 'What scenarios is it suitable for',
      templateFlow: 'How It Works',
      templateStepOne: 'What happens in step one',
      templateStepTwo: 'What happens in step two',
      templateBoundary: 'Boundaries',
      templateBoundaryItem: 'State clearly what this skill does not handle',
    },
  },
  agents: {
    title: 'Agents',
    ...
    feedback: {
      ...
      optionalRuntimeReady: '{{name}} · Runtime ready',
      optionalContractOnly: '{{name}} · Contract reserved',
