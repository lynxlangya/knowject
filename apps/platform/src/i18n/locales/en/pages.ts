export const pagesMessages = {
  ...
  members: {
    ...
    assets: {
      ...
      emptyGroup:
        "No assets of this type are linked to the currently visible projects.",
    },
    detail: {
      ...
      projectDescriptionFallback:
        "This project does not have an additional description yet.",
  ...
  settings: {
    ...
    alerts: {
      ...
      embeddingServicePending:
        "The new model service is waiting for validation",
      ...
      llmRuntimeTitle: "Current LLM settings directly affect project chat.",
    ...
    keyStatus: {
      ...
      lastTested: "Last tested: {{time}}, status {{status}}",
      statusOk: "passed",
      statusFailed: "failed",
    ...
    validation: {
      completeEmbedding:
        "Complete the embedding Base URL and model name first.",
      newServiceApiKey:
      ...
      llmSaveFailed: "Failed to save chat model config. Try again later.",
      ...
      workspaceSaveFailed: "Failed to save workspace info. Try again later.",
      testApiKeyNewService:
        "You switched to a new model service. Enter a new API key before testing.",
      testApiKey: "Enter a new API key before testing.",
  ...
  assets: {
    ...
    createPending:
      "Global asset creation will be connected here in a later phase.",
    importPending:
  ...
  knowledge: {
    ...
    upload: {
      ...
      skippedFiles: "Skipped {{count}} files: {{details}}",
      uploadFailed:
        "The selected files failed to upload. Please try again later",
    ...
    list: {
      ...
      count: "{{count}} total",
      empty:
        "No formal knowledge base yet. Create one first and then upload documents.",
    ...
    search: {
      ...
      action: "Search",
      hint: "After entering a query, the 5 most relevant knowledge chunks and their relevance scores will be returned",
    ...
    management: {
      ...
      emptyDetail:
        "Select a knowledge base from the left to inspect documents and status.",
    ...
    crud: {
      ...
      createFailed:
        "Creating the knowledge base failed. Please try again later",
      updateFailed:
        "Updating the knowledge base failed. Please try again later",
      noDeletable: "There is no deletable knowledge base right now",
      deleted: "Knowledge base deleted",
      deleteFailed:
        "Deleting the knowledge base failed. Please try again later",
    },
    modal: {
  ...
  skills: {
    ...
    definition: {
      ...
      requiredContext: {
        ...
        placeholder:
          "List the documents, code, or facts required before running it.",
      },
      workflow: {
        label: "Workflow",
      ...
      projectBindingNotes: {
        ...
        placeholder:
          "Capture project-specific usage notes or preferred sources.",
      },
