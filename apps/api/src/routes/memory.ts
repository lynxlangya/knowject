...
const DEMO_ITEMS: MemoryItem[] = [
  {
    ...
    source: ".agent/docs/current/architecture.md",
  ...
  },
  {
    ...
    type: "code",
    snippet:
      "前端通过 /api/auth/login 获取 token，受保护路由通过 Bearer token 校验。",
  ...
  },
  {
    ...
    source: ".agent/docs/design/knowject-wordmark-philosophy.md",
    updatedAt: "2026-03-09",
    score: 0.88,
  },
  {
    ...
    type: "document",
    snippet:
      "health、auth、memory 接口用于本地联调与演示，不直接驱动项目态页面内容。",
  ...
  },
  {
    ...
    type: "code",
    snippet:
      "项目资源页只展示已接入资产，全局知识库、技能、智能体页面负责资产治理与复用。",
