...
Audit Knowject's document system as a source-of-truth problem, not a writing problem. Use this skill to decide which documents must change, which directory a document belongs in, and whether derived exports have drifted from `docs/*`.
