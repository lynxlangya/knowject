...
for required_name in JWT_SECRET MONGODB_URI MONGO_APP_USERNAME MONGO_APP_PASSWORD MONGO_APP_DATABASE MONGO_HOST MONGO_PORT MONGO_AUTH_SOURCE MONGODB_DB_NAME; do
