...
> Status: Phase 1 (foundation + `knowject-context-init` Skill). Tier 1 consumer Skills (`knowject-read-design`, `knowject-prd-to-mock`, `knowject-read-api`) ship in Phase 2.
...
| Frontend + Backend | Discover API endpoints during integration; generate a typed client | `knowject-read-api` (Phase 2) |
...
- [ ] Phase 2: `knowject-read-design`, `knowject-prd-to-mock`, `knowject-read-api`
