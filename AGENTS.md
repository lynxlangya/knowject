...
- 项目级 Skill 的 live 根目录已切换到 `.agents/skills/`；`.codex/skills/README.md` 仅保留兼容 stub 跳转。
...
- 涉及以下变化时，必须同步检查并更新文档：
  ...
  - Root governance、工程治理 `standards/`、导出映射或 Skill 根目录变化：同步 `AGENTS.md`、`.codex/README.md`、`.codex/MIGRATION.md`、`docs/README.md`，必要时同步 `docs/exports/README.md`；导出包 active 引用切换在 Task 4 落地后执行；Skill 根目录以 `.agents/skills/README.md` 为当前入口，`.codex/skills/README.md` 仅作兼容 stub。
