...
- 涉及以下变化时，必须同步检查并更新文档：
  ...
  - Root governance、工程治理 `standards/`、导出映射或 Skill 根目录变化：同步 `AGENTS.md`、`.codex/README.md`、`.codex/MIGRATION.md`、`docs/README.md`，必要时同步 `docs/exports/README.md`；导出包 active 引用切换在 Task 4 落地后执行；Skill 根目录在 Task 3 前同步 `.codex/skills/README.md`，Task 3 落地后同步 `.agents/skills/README.md`。
