...
- For architecture, routing, data-source, and Docker facts, use [`.codex/docs/current/architecture.md`](./.codex/docs/current/architecture.md) as the current source of truth.
...
- Do not add new primary docs, packs, or skills under `.agent/*`; use `.codex/*` instead.
...
- Update [`.codex/docs/current/architecture.md`](./.codex/docs/current/architecture.md) when routes, data sources, storage keys, or module boundaries change.
- Update [`.codex/docs/current/docker-usage.md`](./.codex/docs/current/docker-usage.md) and [docker/README.md](./docker/README.md) when Docker topology, ports, secrets, or deployment workflow changes.
- Update [`.codex/packs/chatgpt-projects/README.md`](./.codex/packs/chatgpt-projects/README.md) when the ChatGPT Projects upload bundle mapping or sync boundary changes.
